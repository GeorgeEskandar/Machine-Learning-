...
#Read input data from text file and save in dataMatrix (Nx3) and plot points
matrixData= np.loadtxt("C:\\Users\George\Documents\Term 2 Masters\Machine learning\Exercises\data2Class.txt")
...
p= np.zeros(N)
W= np.zeros((N,N))
#Logistic regression algorithm with quadratic features
for iterator in range(10):
    for i in range(N):
