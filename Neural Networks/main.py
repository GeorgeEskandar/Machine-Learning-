...
def sigmoid(x):
    # x1 = np.zeros((x.size, 1))
    # for r in range(x.size):
    #     x1[r, 0] = 1 / (1 + math.exp(-x[r]))
...
# =========================================================== #
# Load data into matrix and initialize parameters             #
# =========================================================== #

fileName = "C:\\Users\\George\\Documents\\Term 2 Masters\\Machine learning\\Exercises\\data2Class_adjusted.txt"
